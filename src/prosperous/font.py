...
class FontManager:
    def __init__(self, font_path, size=16, vertical_compress=False):
        ...
        debug_log(
            f"[FontManager] Loading: {font_path} at size {size}, vertical_compress={vertical_compress}"
        )
        try:
    ...
    def _generate_atlas(self):
        ...
        for i in range(32, 127):
            ...
            try:
                ...
                raw_matrix = [
                    [1 if pixels[x, y] > 127 else 0 for x in range(canvas_w)]
